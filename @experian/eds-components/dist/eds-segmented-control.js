...
Object(__WEBPACK_IMPORTED_MODULE_0__eds_core_styles__["a" /* addStyle */])('eds-segmented-control', css);
...
module.exports = "/*\n * These variables are available to all components globally and are thus designated with an \"eds-\" prefix.\n * Components may implement these and pass-through to a local variable name.\n */\n[eds-segmented-control] {\n  list-style-type: none;\n  padding: 0;\n  display: flex;\n  flex-flow: row nowrap; }\n  [eds-segmented-control] li, [eds-segmented-control] a {\n    display: block; }\n  [eds-segmented-control] li a {\n    background: #ffffff;\n    cursor: pointer;\n    font-size: 14px;\n    font-weight: 500;\n    border: 1px solid #d8d8d8;\n    border-width: 1px;\n    border-radius: 5px;\n    padding: 10px 20px; }\n  [eds-segmented-control] li[aria-selected=\"true\"] a {\n    border-color: #e63888;\n    background: #e63888;\n    color: #ffffff; }\n  [eds-segmented-control] li:not(:first-child) a {\n    border-top-left-radius: 0;\n    border-bottom-left-radius: 0; }\n  [eds-segmented-control] li:not(:last-child) a {\n    border-top-right-radius: 0;\n    border-bottom-right-radius: 0; }\n  [eds-segmented-control] li:not(:first-child) a {\n    border-left-color: transparent; }\n  [eds-segmented-control] li[aria-selected=\"true\"] + li a {\n    border-left-color: #d8d8d8; }\n"
